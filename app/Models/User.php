...
class User extends Authenticatable
{
    ...
    public function getDiscPercen(): int
    {
        ...
        if (isset(Membership::TIERS[$level])) {
            $val = (int) Membership::TIERS[$level]['discount_val'];
            if ($val > 0) {
                return $val;
            }
        }

        $tier = Membership::progress($this->tier_points ?? 0);
    ...
    public function addPoints(int $points): void
    {
        ...
        $tier = Membership::progress($this->tier_points);
