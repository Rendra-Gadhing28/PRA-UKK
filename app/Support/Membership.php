...
class Membership
{
    ...
    public const TIERS = [
        ...
        'silver' => [
            ...
            'discount_val' => 5,
            'color'        => 'silver',
            'gem_gradient' => 'from-cyan-100 via-sky-300 to-indigo-500',
            'gem_glow'     => 'rgba(56, 189, 248, 0.65)',
            'style_bg'     => 'background: linear-gradient(135deg, #1e1b4b 0%, #312e81 40%, #701a75 75%, #4c1d95 100%);',
            'border_style' => 'border-color: rgba(165, 243, 252, 0.45);',
            'badge_cls'    => 'bg-sky-950/80 text-sky-200 border-sky-500/50',
            'card_class'   => 'text-white',
