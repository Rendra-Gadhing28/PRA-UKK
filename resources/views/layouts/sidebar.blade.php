<div x-data="{ sidebarOpen: false }">
    ...
    <div class="md:hidden flex items-center justify-between bg-white px-4 py-3 border-b border-rose-100 sticky top-0 z-40">
        <div class="flex items-center gap-2.5">
            <div class="w-9 h-9 rounded-full bg-gradient-to-br from-brand-pink to-[#ff8fa4] p-[2px] flex items-center justify-center shadow-md">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'"
        ...
        <div class="p-6 border-b border-rose-50 flex items-center justify-between">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-full bg-gradient-to-br from-brand-pink to-[#ff8fa4] p-[2px] flex items-center justify-center shadow-lg shadow-rose-200">
                ...
                <div>
                    ...
                    <span class="text-[10px] font-bold uppercase tracking-widest text-brand-pink bg-rose-50 px-2 py-0.5 rounded-full inline-block mt-0.5">Admin Executive</span>
                </div>
            </a>
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('admin.dashboard') }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-semibold transition-all {{ request()->routeIs('admin.dashboard') ? 'bg-brand-pink text-white shadow-md shadow-rose-200 font-bold' : 'text-gray-600 hover:text-brand-pink hover:bg-rose-50' }}">
            ...
            <a href="{{ Route::has('admin.treatments.index') ? route('admin.treatments.index') : '#' }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-semibold transition-all {{ request()->routeIs('admin.treatments.*') ? 'bg-brand-pink text-white shadow-md shadow-rose-200 font-bold' : 'text-gray-600 hover:text-brand-pink hover:bg-rose-50' }}">
            ...
            <a href="{{ Route::has('admin.bookings.index') ? route('admin.bookings.index') : '#' }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-semibold transition-all {{ request()->routeIs('admin.bookings.*') ? 'bg-brand-pink text-white shadow-md shadow-rose-200 font-bold' : 'text-gray-600 hover:text-brand-pink hover:bg-rose-50' }}">
            ...
            <a href="{{ Route::has('admin.beauticians.index') ? route('admin.beauticians.index') : '#' }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-semibold transition-all {{ request()->routeIs('admin.beauticians.*') ? 'bg-brand-pink text-white shadow-md shadow-rose-200 font-bold' : 'text-gray-600 hover:text-brand-pink hover:bg-rose-50' }}">
            ...
            <a href="{{ Route::has('admin.finances.index') ? route('admin.finances.index') : '#' }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-semibold transition-all {{ request()->routeIs('admin.finances.*') ? 'bg-brand-pink text-white shadow-md shadow-rose-200 font-bold' : 'text-gray-600 hover:text-brand-pink hover:bg-rose-50' }}">
            ...
            <a href="{{ Route::has('admin.vouchers.index') ? route('admin.vouchers.index') : '#' }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-semibold transition-all {{ request()->routeIs('admin.vouchers.*') ? 'bg-brand-pink text-white shadow-md shadow-rose-200 font-bold' : 'text-gray-600 hover:text-brand-pink hover:bg-rose-50' }}">
                <i class="fa-solid fa-ticket text-brand-pink {{ request()->routeIs('admin.vouchers.*') ? 'text-white' : '' }} text-base"></i>
                <span>Vouchers</span>
            </a>
            ...
            <a href="{{ Route::has('admin.users.index') ? route('admin.users.index') : '#' }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-semibold transition-all {{ request()->routeIs('admin.users.*') ? 'bg-brand-pink text-white shadow-md shadow-rose-200 font-bold' : 'text-gray-600 hover:text-brand-pink hover:bg-rose-50' }}">
                <i class="fa-solid fa-users-gear text-brand-pink {{ request()->routeIs('admin.users.*') ? 'text-white' : '' }} text-base"></i>
                <span>Kelola User</span>
            </a>

            {{-- Profil Admin --}}
            <a href="{{ Route::has('admin.profile.edit') ? route('admin.profile.edit') : '#' }}" 
               class="flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-semibold transition-all {{ request()->routeIs('admin.profile.*') ? 'bg-brand-pink text-white shadow-md shadow-rose-200 font-bold' : 'text-gray-600 hover:text-brand-pink hover:bg-rose-50' }}">
                <i class="fa-solid fa-user-gear text-brand-pink {{ request()->routeIs('admin.profile.*') ? 'text-white' : '' }} text-base"></i>
